                ...
                <div class="container box_1620">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="tentang">Tentang</a></li>
    ...
    <section class="about_area p_120">
        <div class="container">
            <div class="row about_inner">
                <div class="col-lg-6">
                    <div class="about_img">
                        <img class="img-fluid" src="assets/images/gunung/Gunung16.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row team_inner">
                <div class="col-lg-3 col-sm-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="assets/images/instagram/Gambar17.jpg" alt="">
                            <div class="hover">
                                <p>Intan Puja Ningrum adalah teman dari pemilik perusahaan Peonpegu. Ia juga memilik bisnis Mie Setan di Kota Malang.</p>
                                <a href="https://web.facebook.com/profile.php?id=100011541339438"><i class="fa fa-facebook"></i></a>
                                <a href="https://www.instagram.com/intanpn____/"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team_name">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="assets/images/instagram/Gambar1.jpeg" alt="">
                            <div class="hover">
                                <p>Rizki Karianata adalah pemilik dari perusahaan Peonpegu serta ia bercita - cita untuk mendapatkan gelar Sarjana 3.</p>
                                <a href="https://web.facebook.com/rizky.slankers.3386"><i class="fa fa-facebook"></i></a>
                                <a href="https://www.instagram.com/mr.nata007/"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team_name">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="assets/images/instagram/Gambar3.jpg" alt="">
                            <div class="hover">
                                ...
                                <a href="https://web.facebook.com/imam.solihin.35380"><i class="fa fa-facebook"></i></a>
                                <a href="https://www.instagram.com/i.mmam/"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team_name">
                            <h4>Imam Solihin</h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="assets/images/instagram/Gambar24.jpg" alt="">
                            <div class="hover">
                                ...
                                <a href="https://web.facebook.com/ninaanw.ninaanw"><i class="fa fa-facebook"></i></a>
                                <a href="https://www.instagram.com/ninaanw_/"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team_name">
                            <h4>Nina Aryi</h4>
