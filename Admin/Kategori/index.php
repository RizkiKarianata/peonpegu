        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><a href="tambah-kategori" class="btn btn-primary">Tambah</a></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="detail-kategori?id=<?php echo $row['id_kategori'];?>" class="btn btn-secondary">Detail</a></td>
                  </tr>
                <?php } ?>
                </tbody>
              </table>
