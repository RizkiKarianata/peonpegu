...
$query = "SELECT t.id_testimoni, t.isi, t.pekerjaan, u.nama_lengkap, w.nama_wisata FROM tb_testimoni t INNER JOIn tb_user u ON t.id_user = u.id_user INNER JOIN tb_wisata w ON t.id_wisata = w.id_wisata WHERE t.id_testimoni = '$id_testimoni'";
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="pengguna" id="pengguna" class="form-control" readonly="" value="<?php echo $row['nama_lengkap'];?>" style="background-color: #FFFFFF;">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                       ...
                       <input type="text" name="wisata" id="wisata" class="form-control" readonly="" value="<?php echo $row['nama_wisata'];?>" style="background-color: #FFFFFF;">   
                     </div>                   
                   </div> 
                 </div>
                 <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <input type="text" name="pekerjaan" id="pekerjaan" class="form-control" readonly="" value="<?php echo $row['pekerjaan'];?>" style="background-color: #FFFFFF;">
                   </div>
                 </div>
                 <div class="col-md-6">
                  <div class="form-group">
                   <label for="isi">Isi Testimoni</label>
                   <input type="text" name="isi" id="isi" class="form-control" readonly="" value="<?php echo $row['isi'];?>" style="background-color: #FFFFFF;">
                 </div>
               </div> 
             </div>
