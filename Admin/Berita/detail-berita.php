                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="judul" id="judul" class="form-control" placeholder="Judul Berita" required="" autocomplete="off" value="<?php echo $row['judul'];?>">
                        <input type="hidden" name="id_berita" id="id_berita" value="<?php echo $row['id_berita'];?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Tuliskan Keterangan" required=""><?php echo $row['keterangan'];?></textarea>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="ket_singkat">Keterangan Singkat</label>
                        <textarea class="form-control" name="ket_singkat" id="ket_singkat" placeholder="Tuliskan Keterangan Singkat" required=""><?php echo $row['ket_singkat'];?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="ket_lengkap" id="ket_lengkap" placeholder="Tuliskan Keterangan Lengkap" required=""><?php echo $row['ket_lengkap'];?></textarea>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="quotes">Quotes</label>
                        <input type="text" name="quotes" id="quotes" class="form-control" placeholder="Quotes" required="" autocomplete="off" value="<?php echo $row['quotes'];?>">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
