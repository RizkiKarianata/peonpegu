                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="judul" id="judul" class="form-control" placeholder="Judul Berita" required="" autocomplete="off">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Tuliskan Keterangan" required=""></textarea>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="ket_singkat">Keterangan Singkat</label>
                        <textarea class="form-control" name="ket_singkat" id="ket_singkat" placeholder="Tuliskan Keterangan Singkat" required=""></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="ket_lengkap" id="ket_lengkap" placeholder="Tuliskan Keterangan Lengkap" required=""></textarea>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="quotes">Quotes</label>
                        <input type="text" name="quotes" id="quotes" class="form-control" placeholder="Quotes" required="" autocomplete="off">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
