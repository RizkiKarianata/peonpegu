...
include '../../koneksi.php';
$id_wisata = $_GET['id'];
$query = "SELECT w.id_kategori, w.id_wisata, w.nama_wisata, w.alamat, w.ket_singkat, w.ket_lengkap, w.harga, w.stok, w.gambar, k.nama_kategori FROM tb_wisata w INNER JOIN tb_kategori k ON w.id_kategori = k.id_kategori WHERE w.id_wisata = '$id_wisata'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_wisata" id="nama_wisata" class="form-control" placeholder="Nama Wisata" required="" autocomplete="off" value="<?php echo $row['nama_wisata'];?>">
                        <input type="hidden" name="id_wisata" id="id_wisata" value="<?php echo $row['id_wisata'];?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
