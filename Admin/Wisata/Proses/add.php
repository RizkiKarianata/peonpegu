...
<body>
	...
	$query = "INSERT INTO tb_wisata(id_kategori, nama_wisata, alamat, ket_singkat, ket_lengkap, harga, stok, gambar, created, modified) VALUES ('$id_kategori', '$nama_wisata', '$alamat', '$ket_singkat', '$ket_lengkap', '$harga', '$stok', '$gambar', '$created', '$modified')";
