...
$query = "SELECT t.id_transaksi, t.jumlah_pesan, t.status, t.total_harga, u.nama_lengkap, w.nama_wisata FROM tb_transaksi t INNER JOIN tb_user u ON t.id_user = u.id_user INNER JOIN tb_wisata w ON t.id_wisata = w.id_wisata WHERE t.id_transaksi = '$id_pendapatan'";
