        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                <a href="Proses/print-pendapatan" class="btn btn-success" target="_blank">Print</a>
                <a href="Proses/excel-pendapatan" class="btn btn-danger" target="_blank">Excel</a>
              </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="detail-pendapatan?id=<?php echo $row['id_transaksi'];?>" class="btn btn-secondary">Detail</a></td>
                  </tr>
                <?php } ?>
                </tbody>
              </table>
