...
$query = "SELECT t.id_transaksi, t.jumlah_pesan, t.status, t.total_harga, u.nama_lengkap, w.nama_wisata FROM tb_transaksi t INNER JOIN tb_user u ON t.id_user = u.id_user INNER JOIN tb_wisata w ON t.id_wisata = w.id_wisata WHERE t.id_transaksi = '$id_transaksi'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="id_wisata" id="id_wisata" class="form-control" value="<?php echo $row['nama_wisata'];?>" readonly="" style="background-color: #FFFFFF;">
                      </div>
                    </div> 
                  </div>
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select name="status" id="status" required="" class="form-control">
                          ...
                          if($row['status'] == '0') {
                            ...
                            echo "<option value='1'>Proses</option>";
                            echo "<option value='2'>Berhasil</option>";
